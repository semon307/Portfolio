            ...
            <div className={`${container.container} ${s.footerContainer}`}>
                <div className={s.content}>
                    ...
                    <div className={s.iconBlock}>
                        <div className={s.icon}><FontAwesomeIcon className={s.fontAwesome} icon={faGithub}/></div>
                        <div className={s.icon}><FontAwesomeIcon className={s.fontAwesome} icon={faLinkedin}/></div>
                        <div className={s.icon}><FontAwesomeIcon className={s.fontAwesome} icon={faEnvelope}/></div>
                        <div className={s.icon}><FontAwesomeIcon className={s.fontAwesome} icon={faFacebook}/></div>
                    </div>
